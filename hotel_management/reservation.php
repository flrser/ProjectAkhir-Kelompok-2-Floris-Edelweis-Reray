...
?>
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="padding-bottom: 3.5rem;">
  
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" style="margin-left: 10px;;">Reservation</h1>
        </div>
    </div><!--/.row-->
                    ...
                    if (isset($_GET['room_id'])){?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn btn-primary pull-right" href="index.php?room_mang">Replan Booking</a>
                            </div>
