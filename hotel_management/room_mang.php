        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Room Management
                    <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addRoom"> <i class="fa fa-plus" aria-hidden="true"></i> Add Room</button>
                    <a href="index.php?history_room" class="btn btn-warning pull-right" style="margin-right: 25px;"><i class="fa fa-history" aria-hidden="true"></i> History Room</a>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="rooms">
                        ...
                        <tbody>
                        <?php
                        $room_query = "SELECT * FROM view_room_roomtype";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button title="Edit Room Information" data-toggle="modal"
                                                ...
                                                id="roomEdit" class="btn btn-primary"><i class="fa fa-pencil"></i></button>
                                        <?php
                                        if ($rooms['status'] == 1) {
                                            ...
                                            echo '<button title="Customer Information" class="btn btn-secondary" style="cursor-pointer: none;" disabled><i class="fa fa-eye"></i></button>';
                                        }
                                        ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="" id="addRoom" data-toggle="validator" role="form">
                                <input type="hidden" value="tes" name="tes" id="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="room_type_id" required
                                        ...
                                        <?php
                                        $query = "SELECT * FROM view_room_type";
