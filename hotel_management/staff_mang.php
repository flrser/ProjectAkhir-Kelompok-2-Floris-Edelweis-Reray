        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Employee Details:
                    <a href="index.php?add_emp" class="btn btn-primary pull-right">Add Employee</a>
                </div>
                        ...
                        if (mysqli_num_rows($staff_result) > 0) {
                            ...
                            while ($staff = mysqli_fetch_assoc($staff_result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-success" data-toggle="modal" data-target="#changeShift"
